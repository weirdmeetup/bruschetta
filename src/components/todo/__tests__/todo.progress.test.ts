...
const mock: IIssueWithID[] = [
  ...
  { id: 'parent01', text: '[ ] parent 1', type: EN_ISSUE_TYPE.TASK, depth: 1 },
  { id: 'p01_c01', text: '[ ] child', type: EN_ISSUE_TYPE.TASK, depth: 2 },
  { id: 'p01_c02', text: '[x] child', type: EN_ISSUE_TYPE.TASK, depth: 2 },
  { id: 'parent02', text: '[x] parent 2', type: EN_ISSUE_TYPE.TASK, depth: 1 },
  { id: 'p02_c01', text: '[ ] child', type: EN_ISSUE_TYPE.TASK, depth: 2 },
  { id: 'p02_c02', text: '[x] child', type: EN_ISSUE_TYPE.TASK, depth: 2 },
  { id: 'p02_c02_c01', text: '[x] child', type: EN_ISSUE_TYPE.TASK, depth: 3 },
  { id: 'p02_c03', text: '[ ] child', type: EN_ISSUE_TYPE.TASK, depth: 2 },
